...
is the bundle for a Saudi voice agent's replies; `ARAB_PHONE_REGIONS` and
`IDENTIFIER_WORDS` are the tuples it is built from. The numbering plans it reads are

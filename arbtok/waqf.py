...
Provenance: vendored verbatim from ``text2tashkeel.waqf`` (TigreGotico/
text2tashkeel, Apache-2.0 — the same org and license as arbtok). The transform
is deterministic, model-free, and cited to primary grammars below, so there is
nothing to drift from once copied; arbtok carries it so that diacritization is
